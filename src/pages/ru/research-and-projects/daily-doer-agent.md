...
title: "DailyDoer Agent: диалоговый Telegram-бот"
...
tags: ["Gemini API", "Telegram-бот", "Google API", "Python", "Веб-скрейпинг", "NLP"]
---
...
- **BeautifulSoup4** собирает ссылки с заранее выбранных новостных сайтов. Gemini суммаризирует материалы и формирует ежедневный обзор.
...
1. **Нестабильная структура сайтов:** HTML новостных страниц часто меняется, поэтому CSS-селекторы BeautifulSoup4 перестают работать.
   - *Решение:* основной текст извлекается устойчивыми правилами `newspaper3k`, а BeautifulSoup4 отвечает только за сбор ссылок с главной страницы.
